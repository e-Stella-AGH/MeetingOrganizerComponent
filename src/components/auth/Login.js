    ...
    >
      ...
      <Box m={2} mt={0}>
        <CardActions style={{float: "right", marginRight: "15%"}}>
            <Button color="primary" variant="contained" style={{...buttonStyle}} onClick={handleSubmit}>Login</Button>
        </CardActions>
        <Box style={{marginLeft: "16%", display: "inline-block"}} mt={1}>
          <Button color="primary" variant="outlined" style={{...buttonStyle}} onClick={redirectToRegister}>Need an account?</Button>
        </Box>
      </Box>
    </Card>
  )
