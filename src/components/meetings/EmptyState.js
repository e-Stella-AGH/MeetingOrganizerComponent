...
export const EmptyState = ({ reload, setReload, meetingValues }) => {
    ...
    return (
        <div style={{marginLeft: 'auto', marginRight: 'auto', width: '70%', textAlign: 'center'}}>
            ...
            <Button color="primary" onClick={() => addMeetingPath(reload, setReload, meetingValues)} size="large" variant="contained" style={{marginTop: '2em'}}>Create one now</Button>
        </div>
    )
}